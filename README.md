...
12. Hossain, M.S. & Mahmud, H. (2018). Short-term load forecasting using ARIMA model for Bangladesh. *International Journal of Energy*, 7(2), 31–40.
13. Islam, M.A., et al. (2019). Electricity demand forecasting of Bangladesh using artificial neural network. *Journal of Electrical Engineering*, 47(1), 1–8.
